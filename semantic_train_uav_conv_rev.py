...
for epoch in range(NUM_EPOCHS):
    ...
    if train_loss < BEST_TRAIN_LOSS:
        saveModel(model, optimizer, lr_scheduler, epoch, train_loss, 'checkpoints/best_train_uav_conv_rev.pth')
    if val_loss < BEST_VAL_LOSS:
        saveModel(model, optimizer, lr_scheduler, epoch, val_loss, 'checkpoints/best_val_uav_conv_rev.pth')
